...
# params = list(
#     utils_path = "/nfshomes/zaza/sc_read_census/nextflow/modules/downstream_analysis/r_utils.R",
...
```{r}
shuf_genes_hist_dir = file.path(hist_dir, "sense_genes")
...
pdf(file.path(shuf_genes_hist_dir, "shuffled_correlation.pdf"), width = 10, height = 10)
...
pdf(file.path(shuf_genes_hist_dir, "shuffled_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(shuf_genes_hist_dir, "shuffled_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(shuf_genes_hist_dir, "shuffled_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "spliced_correlation.pdf"), width = 10, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "spliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "spliced_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "spliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "unspliced_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "unspliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "unspliced_correlation_pearson.pdf"), width = 20, height = 10)
...
dev.off()
pdf(file.path(sense_genes_hist_dir, "unspliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "ambiguous_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "ambiguous_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "ambiguous_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "ambiguous_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "usa_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "usa_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "usa_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_genes_hist_dir, "usa_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "spliced_correlation.pdf"), width = 10, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "spliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "spliced_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "spliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "unspliced_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "unspliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "unspliced_correlation_pearson.pdf"), width = 20, height = 10)
...
dev.off()
pdf(file.path(antisense_genes_hist_dir, "unspliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "ambiguous_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "ambiguous_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "ambiguous_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "ambiguous_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "usa_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "usa_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "usa_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(antisense_genes_hist_dir, "usa_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "spliced_correlation.pdf"), width = 10, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "spliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "spliced_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "spliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "unspliced_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "unspliced_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "unspliced_correlation_pearson.pdf"), width = 20, height = 10)
...
dev.off()
pdf(file.path(sense_antisense_genes_hist_dir, "unspliced_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "ambiguous_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "ambiguous_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "ambiguous_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "ambiguous_correlation_cosine.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "usa_correlation.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "usa_correlation_spearman.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "usa_correlation_pearson.pdf"), width = 20, height = 10)
...
pdf(file.path(sense_antisense_genes_hist_dir, "usa_correlation_cosine.pdf"), width = 20, height = 10)
