...
params = list(
    ...
    sense_quant_dir = "/nfshomes/zaza/cbcb-scratch/Projects/sc_read_concensus/nextflow/workflow_output/quantification/500_PBMC_3p_LT_Chromium_X/refdata-gex-GRCh38-2020-A/simpleaf_quant/fw/af_quant",
    antisense_quant_dir = "/nfshomes/zaza/cbcb-scratch/Projects/sc_read_concensus/nextflow/workflow_output/quantification/500_PBMC_3p_LT_Chromium_X/refdata-gex-GRCh38-2020-A/simpleaf_quant/rc/af_quant",
    out_dir = ".",
    sample_type = "cell",
    num_threads = 10,
    num_pcs = 50,
...
In scRNA-seq, antisense reads are an non-trivial read group but have been ignored  
