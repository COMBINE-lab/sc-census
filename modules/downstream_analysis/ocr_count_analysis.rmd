...
pdf(file.path(hist_dir, "intergenic_width_count_ratio_hist_ocr.pdf"), width = 10, height = 10)
...
pdf(file.path(hist_dir, "intergenic_width_count_ratio_hist_ccres.pdf"), width = 10, height = 10)
...
pdf(file.path(hist_dir, "ocr_intergenic_count_hist.pdf"), width = 10, height = 10)
